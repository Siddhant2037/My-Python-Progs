try:
    ...
    #for bus
    if imp=="yes":
        imp2=str(input("Which one do you want to see Bus,Aeroplan,Railway?"))
        if imp2=="bus":
            f=open("bus.txt","r")
            print(f.read())
        elif imp2=="Aeroplane":
       ...
       if in2<7:
           ...
           if in3==1:
               ...
               if in4=='yes':
                   ...
                   while no<=in5:
                       ou1=str(input(f"Enter your name no{no}"))
                       no=no+1
                       f=open("bus.txt","a")
                       f.write(f"\n{ou1}" )
                       f.close()
    ...
    print("Something went wrong please enter valid input Thankyou")
